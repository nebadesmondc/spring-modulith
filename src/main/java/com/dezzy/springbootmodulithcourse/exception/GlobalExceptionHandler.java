...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleModulithException(ModulithException ex) {
        return new ResponseEntity<>(new ErrorResponse(ex.getLocalizedMessage(), HttpStatus.BAD_REQUEST), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Map<String, List<String>>> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        return new ResponseEntity<>(getErrorMap(fieldErrors), HttpStatus.BAD_REQUEST);
    }
